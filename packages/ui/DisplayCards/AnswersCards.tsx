...
const AnswerCard = ({ answer }: AnswerCardProps) => {
	if (
		...
		return (
			<div className="mb-4 last:mb-0 p-3 max-w-md w-full shadow-md shadow-gray-400 rounded-md bg-white">
	...
	return (
		<>
			<div className="w-full min-h-full flex flex-col items-center justify-center">
				<div className="pb-4 flex items-center justify-center capitalize text-2xl text-main font-bold text-center w-full [&>a]:scale-150">
					<TextLink link="/compatibility/answers">{"<"}</TextLink>
